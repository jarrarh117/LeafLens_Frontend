...
export default function APIDocsPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <h2 className="text-xl font-bold text-stone-900 dark:text-white mb-4">Quick Start</h2>
          <ol className="space-y-3 text-stone-600 dark:text-stone-400">
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full flex items-center justify-center text-sm font-bold">1</span>
              <span>
                Sign up at{" "}
                <Link href="/signup" className="text-emerald-600 hover:text-emerald-700 font-semibold">
                  leaflens-six.vercel.app/signup
                </Link>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full flex items-center justify-center text-sm font-bold">2</span>
              <span>
            ...
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 rounded-full flex items-center justify-center text-sm font-bold">3</span>
        ...
        >
          ...
          <p className="text-stone-600 dark:text-stone-400 mb-4">
            All API requests require authentication using an API key. Include your key in the <code className="bg-stone-100 dark:bg-stone-800 px-2 py-1 rounded">x-api-key</code> header.
          </p>
          <div className="bg-stone-100 dark:bg-stone-800 rounded-xl p-4 font-mono text-sm text-stone-800 dark:text-stone-200">
            x-api-key: pd_live_your_api_key_here
          </div>
        </motion.section>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <code className="text-lg font-mono text-stone-900 dark:text-white">/v1/predict</code>
          </div>
          ...
          <div className="bg-stone-100 dark:bg-stone-800 rounded-xl p-4 mb-6 overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody className="font-mono text-stone-800 dark:text-stone-200">
                <tr>
                  <td className="py-1 pr-4">x-api-key</td>
                  <td className="py-1 pr-4">pd_live_xxxxx</td>
  ...
  -H "x-api-key: pd_live_xxxxxxxxxxxxxxxxxxxx" \\
...
# Your API key
API_KEY = "pd_live_xxxxxxxxxxxxxxxxxxxx"
...
if response.status_code == 200:
    ...
    print(f"Error: {error.get('error', 'Unknown error')}")`}
          ...
          <CodeBlock 
            section="javascript"
            code={`const API_KEY = "pd_live_xxxxxxxxxxxxxxxxxxxx";
...
console.log(\`Confidence: \${result.confidence}\`);`}
          ...
          {/* Response */}
          <h3 className="font-semibold text-stone-900 dark:text-white mb-3 mt-6">Response (200 OK)</h3>
        ...
        >
          ...
          <div className="space-y-4">
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4">
              ...
              <code className="text-sm text-red-700 dark:text-red-300">{"{ \"error\": \"Invalid API key\" }"}</code>
            </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-4">
              ...
              <code className="text-sm text-purple-700 dark:text-purple-300">{"{ \"error\": \"Rate limit exceeded\", \"retryAfter\": 60 }"}</code>
            </div>
          </div>
        </motion.section>
